  ...
  const shops = [
    {
      ...
      products: [
        {
          id: 101,
          name: "Concert Ticket - Mugham Night",
          price: 35,
          image:
        ...
        {
          id: 103,
          name: "Theater Show - Classic Drama",
          price: 45,
          image:
            "https://images.unsplash.com/photo-1503095396549-807759245b35?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
        },
        {
          id: 104,
          name: "Football Match - Premier League",
          price: 60,
          image:
    ...
    },
    {
      id: 2,
      name: "Hesab.az",
      logo: "https://www.mastercard.az/content/dam/public/mastercardcom/eu/az/en/odenis/icons/hesabaz.jpg",
      category: "Utilities",
      products: [
        {
          id: 201,
    ...
    },
    {
      ...
      products: [
        ...
        },
        {
          ...
          price: 32,
          image:
            "https://images.unsplash.com/photo-1452195100486-9cc805987862?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
        },
        {
          id: 403,
          ...
          price: 18,
          image:
            "https://images.unsplash.com/photo-1559056199-641a0ac8b55e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
        },
        {
          id: 404,
          name: "Organic Meat Package",
          price: 65,
          image:
  ...
  const verifyPayment = () => {
    ...
    setTimeout(() => {
      ...
      if (!savedCode || !savedExpiry || parseInt(savedExpiry) < now) {
        setVerificationError(
          "Invalid or expired code. Please generate a new code."
        );
      ...
      if (savedAmount && parseFloat(savedAmount) < cartTotal) {
        setVerificationError(
          `Payment amount (${parseFloat(savedAmount).toFixed(
            2
          )}₼) is less than cart total (${cartTotal.toFixed(
            2
          )}₼). Please generate a code with sufficient amount.`
        );
        setIsVerifying(false);
        return;
      }
    ...
    <div className="min-h-screen bg-gray-100">
          ...
          <div className="flex gap-x-6 min-w-max">
            {shops.map((shop) => (
              <div
                ...
                className={`flex flex-col items-center py-2 gap-y-2 cursor-pointer transition-all duration-200 ${
              ...
              >
                ...
                {activeShop?.id === shop.id && (
                  <div className="h-1 w-10 bg-[#007d56] rounded-full"></div>
                )}
              </div>
            ))}
          </div>
      ...
      <div className="container mx-auto lg:px-16 sm:px-8 px-4 py-8 overflow-hidden">
        {activeShop ? (
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mt-8">
              {activeShop.products.map((product) => (
                <div
                  key={product.id}
                  className="group bg-white rounded-2xl shadow-sm overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 relative"
                >
                  <div className="relative h-48 sm:h-56 overflow-hidden">
                    ...
                    />
                    <div className="absolute bottom-0 left-0 right-0 p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 z-20 hidden md:block">
                      <button
                  ...
                  <div className="p-5">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="font-semibold text-lg text-gray-800 group-hover:text-[#007d56] transition-colors line-clamp-2">
                        {product.name}
                      </h3>
                      <span className="bg-[#e6f2ee] text-[#007d56] font-bold px-3 py-1 rounded-full text-sm ml-2 whitespace-nowrap">
                        ₼{product.price.toFixed(2)}
                      </span>
                    </div>
                    <p className="text-gray-500 text-sm line-clamp-2 mt-2">
                      {product.description ||
                        `Premium quality ${product.name.toLowerCase()} available now with fast delivery.`}
                    </p>

                    {/* Mobile-only Add to Cart button */}
                    <button
                      onClick={() => addToCart(product)}
                      className="md:hidden w-full mt-4 bg-[#007d56] hover:bg-[#005a3e] text-white font-medium py-2 rounded-lg flex items-center justify-center gap-2 transition-colors"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5"
          ...
          <div>
            <h1 className="text-2xl font-bold mb-6 text-[#007d56]">
              Our Partners
            </h1>
            <p className="text-gray-600 mb-8">
              Shop with our trusted partners and pay securely with PashaMood.
            </p>
                  ...
                  {cart.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[#007d56] font-bold">
              ...
              <div className="p-8 text-center">
                ...
                <div className="bg-gray-50 rounded-xl p-4 mb-6">
                  <p className="text-gray-600">
                    PashaMood code verification was successful. Thank you for
                    your purchase!
                  </p>
                </div>
                <button
