...
const Profile = () => {
  ...
  const generateTempCode = () => {
    ...
    if (parseFloat(paymentAmount) > userData.balance) {
      setAmountError(`Məbləğ balansınızdan çox ola bilməz (${userData.balance.toFixed(2)}${userData.currency})`);
      return;
    }
      ...
      <header className="bg-[#007d56] text-white shadow-lg">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <Link to="/">
              <div className="bg-white rounded-full p-3 mr-2 sm:w-44 w-28">
                <img
                  src="/logo.png"
                  alt="PashaMood"
            ...
            <div className="bg-white rounded-xl shadow-md p-6 overflow-hidden">
              ...
              {activeTab === "payment" && (
                <motion.div
                  ...
                  className="sm:p-6 bg-white rounded-lg"
                >
                  <h2 className="text-2xl font-bold mb-6 text-[#007d56]">
                    Generate Payment Code
                  </h2>
                  <p className="text-gray-600 mb-6">
                    Generate a temporary payment code that can be used for the
                    next 2 minutes.
                  </p>
                      ...
                      <div className="w-full max-w-md mx-auto">
                        ...
                        <div className="bg-white p-6 rounded-b-xl shadow-md">
                          ...
                          <p className="text-sm text-gray-600 text-center mb-4">
                            Scan this code with the merchant's app to complete
                            your payment.
                          </p>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                if (parseFloat(value) > userData.balance) {
                                  setAmountError(`Məbləğ balansınızdan çox ola bilməz (${userData.balance.toFixed(2)}${userData.currency})`);
                                } else {
                                  setAmountError("");
                                }
                              }}
                              className={`w-full pl-10 pr-4 py-3 border ${amountError ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-[#007d56] focus:border-[#007d56] transition-colors`}
                              placeholder="0.00"
                            />
                          </div>
                          {amountError && (
                            <p className="mt-2 text-red-600 inter text-sm">{amountError}</p>
                          )}
                        </div>
